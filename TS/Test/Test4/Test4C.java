...
static public void main(String[] arg)throws Exception{
      ...
      JFrame jf = new JFrame("ÁÈ¤j¿úTest4C Buy");
      Test4CKD   skd = new Test4CKD(arg[0],arg[1]);
//     Test4CKD   skd2 = new Test4CKD(arg[0],arg[1],2);
      MotherPanel mp = new MotherPanel();
    //  KPainting baseLine = new KPainting(skd.culKLine());
  //    KPainting baseLine2 = new KPainting(skd2);
  ...
  //    baseLine2.setDownColor(Color.GREEN);
   ...
   //   mp.addPainting(baseLine2);
    ...
    //  mp.addPainting(new MAPainting(skd2,8,new Color(0,150,0)));
  //    mp.AutoTuneY();
  //    mp.tuneXGap(20);
