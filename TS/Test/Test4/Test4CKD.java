...
public class Test4CKD extends StockKD{

public   Test4CKD(String snum)throws Exception
 {
 	   this(snum, "20090101");
 }
...
public  Test4CKD(String snum,String dateStr)throws Exception
 {
  // dayKdata = ;
   ...
   while(e.hasMoreElements())
   {
       ...
       float rangeHighBound =(float)( rp * 1.03);
          ...
          "from  pamountinfo4A where snum='"+snum+"' and date >= '"+getBWorkDay(plr.date,snum)+"' and date <= '"+plr.date+"' and rangeS >"+
           rangeLowBound+" and rangeS <"+rangeHighBound+"  group by snum; ";
