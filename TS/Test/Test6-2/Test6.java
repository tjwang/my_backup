...
static public void main(String[] arg)throws Exception{
      ...
      mp.addPainting(new MAPainting(skd.culAvgBIdxLine(10),new Color(150,0,0)),"外資均買點", 0);
      mp.addPainting(new MAPainting(skd2.culAvgSIdxLine(10),new Color(0,150,0)),"外資均賣點", 0);
      mp.addPainting(new MAPainting(fbvl.culMALine(10),new Color(150,0,0)),"買量均線", 1);
      mp.addPainting(new MAPainting(fsvl.culMALine(10),new Color(0,150,0)),"賣量均線", 1);
