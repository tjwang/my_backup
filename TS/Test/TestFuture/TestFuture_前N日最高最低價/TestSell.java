...
public class TestSell extends StockKD{


public  TestSell(String dateStr,int type)throws Exception
 {
...
static public void main(String[] arg)throws Exception
{
      ...
      for(lenpattern_len = 1; lenpattern_len < 3;lenpattern_len++)
      {
         ...
         for(int i=lenpattern_len;i<l.length();i++)
         {
            ...
            LPricePattern hp = new LPricePattern((int)pv._kv.getLow()+diff,cutoff,gotoff,9999);
