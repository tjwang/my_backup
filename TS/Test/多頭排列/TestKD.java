...
public  TestKD(String snum,String dateStr,int type)throws Exception
 {
   ...
   Enumeration e = plr.SelectBySQL("select snum,date,time,open,high,low,rp as close,total as volume,total as  money from plast2 where snum = '"+snum+"' and date>'"+dateStr+"' order by date;");
