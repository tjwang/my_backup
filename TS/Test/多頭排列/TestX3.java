...
public class TestX3 {
 ...
 static Hashtable ht ;
  ...
  static public boolean checkValue2(Line l1, Line l2,Line l3)
  {
     for(int i = 10; i < 25; i++)
     {
        Value v1 = l1.valueAt(i);
        ...
        if(v1.getValue() < 0 || v2.getValue()< 0 || v2.getValue()< 0)
        {
            return false;
        }
     }  
...
//         Line dif_3 = sub_m5.diff(sub_m13);
         Line dif_3 = sub_m13.diff(sub_m21);
        if(checkValue2(dif_1,dif_2,dif_3))
         {
