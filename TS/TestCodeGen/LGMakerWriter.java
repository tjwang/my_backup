...
public class LGMakerWriter extends BasicWriter{
  String[] _factoryNames;
  public LGMakerWriter(OutputStream out, String mn,String[] fnames) throws Exception
  {
     _tbl_name="LG_Maker.tbl"; 
  ...
  public void output() throws Exception
  {
     ...
     while((lineData=tbl_in.readLine())!=null)
     {
         ...
         lineData = lineData.replaceAll("###Factory3###",_factoryNames[2]);
