...
public class StatiWriter extends BasicWriter{
  String[] _factoryNames;
  String _pname;
  public StatiWriter(OutputStream out, String mn,String[] fnames, String pname)throws Exception
  {
  	  _tbl_name="StaTPL.tbl"; 
  	  _pname = pname;
