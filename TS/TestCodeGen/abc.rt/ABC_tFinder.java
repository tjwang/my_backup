...
static public void main(String[] arg)throws Exception{
      ...
      while(e.hasMoreElements())
      {
         ...
         if(check_snum != null && check_snum.get(ds000r.snum) == null)
         {
      	 ...
      	 total++;
         ABC_sFactory   fac1 = new ABC_sFactory(ds000r.snum,arg[0]);
         ABC_oFactory   fac2 = new ABC_oFactory(ds000r.snum,arg[0]);
         ...
         ABC_Pattern   ptn1 = new ABC_Pattern(markLine,basicGroup);
         try
         {
