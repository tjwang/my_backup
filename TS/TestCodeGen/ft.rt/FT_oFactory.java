...
public class FT_oFactory extends KDataLineFactory{
    ...
    public    FT_oFactory(String snum,String stardate) throws Exception
    {
        _snum = snum;
    ...
    public void loadKData(String snum,String stardate) throws Exception
    {
        ...
        Enumeration e = null;
        if(stardate == null){
            e = pkr.SelectBySQL("select * from  pldayk where   snum='0001' order by date,time "  ); 
        }else {
            e = pkr.SelectBySQL("select * from  pldayk where   snum='0001' and date > '"+stardate+"' order by date,time "  );    
        }
