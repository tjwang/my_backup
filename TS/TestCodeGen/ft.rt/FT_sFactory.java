...
public class FT_sFactory extends KDataLineFactory{
    ...
    public    FT_sFactory(String snum,String stardate) throws Exception
    {
        _snum = snum;
    ...
    public void loadKData(String snum,String stardate) throws Exception
    {
        ...
        Enumeration e = null;
        if(stardate == null){
            e = pkr.SelectBySQL("select 'TX01' as snum,date,0 as time,pxfsum.call as open , put as high, cpsum as low, Tcpsum as close, "+
                                 " Tcall as volume, Tput as money from pxfsum where  kind='TXF' and type='F'  order by date "  ); 
        }else {
            e = pkr.SelectBySQL("select 'TX01' as snum,date,0 as time,pxfsum.call as open , put as high, cpsum as low, Tcpsum as close, "+
                                 " Tcall as volume, Tput as money from pxfsum where  date > '"+stardate+"' and kind='TXF' and type='F'  order by date "  ); 
        }
