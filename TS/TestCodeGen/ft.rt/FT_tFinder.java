...
static public void main(String[] arg)throws Exception{
      ...
      while(e.hasMoreElements())
      {
         ...
         if(check_snum != null && check_snum.get(ds000r.snum) == null)
         {
      	 ...
      	 total++;
         FT_sFactory   fac1 = new FT_sFactory(ds000r.snum,arg[0]);
         FT_oFactory   fac2 = new FT_oFactory(ds000r.snum,arg[0]);
         ...
         FT_Pattern   ptn1 = new FT_Pattern(markLine,basicGroup);
         try
         {
