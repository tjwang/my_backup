 ...
 static void loadTargets(String filename)  throws Exception
{
 ...
 static public void main(String[] arg)throws Exception{
      ...
      JFrame jf2 = new JFrame("FT_tUI");
      jp2= new JScrollPane();
 
//      JFrame jf_xd = new JFrame("FT_tUI_Xd");
...
/******************* Source Data Select******************/
      FT_sFactory  fac1 = new FT_sFactory(snum,dss);
      FT_oFactory  fac2 = new FT_oFactory(snum,dss);


      LineGroup basicGroup =  LG_Maker.basic(fac1,fac2);
      KLine markLine =   (KLine)LG_Maker.markLine(basicGroup);
...
// Line data building
      ...
      fac2_lines[0] = markLine.getClose();
      fac2_lines[1] = fac2_lines[0].avg(5);
      fac2_lines[2] = fac2_lines[0].avg(20);
...
//      mp.addPainting(new VPainting(markLine,new Color(200,200,200)),"fac2-1",1);
      mp.addPainting(new MAPainting(fac2_lines[0],new Color(150,0,0)),"fac2-1",1);
      mp.addPainting(new MAPainting(fac2_lines[1],new Color(0,150,0)),"fac2-2",1);
     mp.addPainting(new MAPainting(fac2_lines[2],new Color(0,0,150)),"fac2-3",1);
