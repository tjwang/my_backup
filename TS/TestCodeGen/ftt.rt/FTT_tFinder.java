...
//         }
      	 total++;
         FTT_sFactory   fac1 = new FTT_sFactory(ds000r.snum,arg[0]);
//         FTT_sFactory   fac1 = new FTT_sFactory();
         /*
         FTT_oFactory   fac2 = new FTT_oFactory(ds000r.snum,arg[0]);
         ...
         FTT_Pattern   ptn1 = new FTT_Pattern(markLine,basicGroup);
         try
         {
