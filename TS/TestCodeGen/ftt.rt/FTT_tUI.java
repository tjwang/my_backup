...
public class FTT_tUI {
  ...
  static boolean display_external_win = false;
 ...
 static void loadTargets(String filename)  throws Exception
{
 ...
 static public void main(String[] arg)throws Exception{
      ...
      JFrame jf2 = new JFrame("FTT_tUI");
      jp2= new JScrollPane();
      
      JFrame jf_xd = null;
 
 if(display_external_win)
 {
      jf_xd = new JFrame("FTT_tUI_Xd");
     ...
     Container jc_xd = null;
 if(display_external_win)
 {
 	     jc_xd = jf_xd.getContentPane();
...
/******************* Source Data Select******************/
      FTT_sFactory  fac1 = new FTT_sFactory(snum,dss);
      FTT_oFactory  fac2 = null;//new FTT_oFactory(snum,dss);
...
// Line data building
      Line[] fac1_lines = basicGroup.getSubLineArray();
...
//  Region  1 <Factory1>   
//fac1_lines[1].dump();
      mp.addPainting(new MAPainting(fac1_lines[1],new Color(150,0,0)),"TX084",0);
     if( fac1_lines[0] instanceof KLine)
     {
         mp.addPainting(new KPainting((KLine)fac1_lines[0]),"TX", 0);
     } else
     {
         mp.addPainting(new MAPainting(fac1_lines[0],new Color(0,0,150)),"TX",0);
     }
//      mp.addPainting(new MAPainting(fac1_lines[2],new Color(0,0,150)),"TX_SELF",0);
...
*/
      mp.addPainting(new MAPainting(fac1_lines[7].avg(3),new Color(150,0,0)),"Up_Sta3",1);
      mp.addPainting(new MAPainting(fac1_lines[7].avg(8),new Color(0,150,0)),"Up_Sta8",1);
//      mp.addPainting(new MAPainting(fac1_lines[3],new Color(0,150,0)),"2317",1);
//      mp.addPainting(new MAPainting(fac1_lines[4],new Color(0,0,150)),"2454",1);
//      mp.addPainting(new MAPainting(fac1_lines[5],new Color(150,150,0)),"2412",1);
//      mp.addPainting(new MAPainting(fac1_lines[3],new Color(0,150,0)),"Sell",1);
