...
public class MF_Pattern extends MarkPattern {

    Line _kl;
    MF_Pattern(Line ml,Line kl)
    {
        super(ml);
        _kl = kl;
    }
    ...
    public PatternValue find(Line l, int startIdx)
    {
       ...
       if(ptv!=null)
       {
          GroupValue v = (GroupValue)l.valueAt(ptv.getStartIdx());
          KValue kv = (KValue)v.getMainValue();
          if(kv.getVolume() < 2000) return null;
       }
