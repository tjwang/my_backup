...
/******************* Source Data Select******************/
      MF_sFactory  fac1 = new MF_sFactory(arg[0],arg[1]);
      MF_oFactory  fac2 = new MF_oFactory(arg[0],arg[1]);
...
*/
      mp.addPainting(new VPainting(markLine,new Color(150,0,0)),"fac2-1",1);
      mp.addPainting(new VPainting(markLine.constant(0).add(markLine,10),new Color(0,150,0)),"fac2-2",1);
      mp.addPainting(new VPainting(markLine.constant(0).add(markLine,10).and(markLine),new Color(0,0,150)),"fac2-x",1);
