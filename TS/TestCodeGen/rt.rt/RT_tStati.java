...
static public void main(String[] arg)throws Exception{
      ...
      while(e.hasMoreElements())
      {
         ...
         RT_sFactory   fac1 = new RT_sFactory(ds000r.snum,arg[0]);
         RT_oFactory   fac2 = new RT_oFactory(ds000r.snum,arg[0]);
         ...
         RT_Pattern   ptn1 = new RT_Pattern(basicGroup,markLine);
