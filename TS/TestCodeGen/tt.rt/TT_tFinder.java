...
static public void main(String[] arg)throws Exception{
      ...
      while(e.hasMoreElements())
      {
         ...
         if(check_snum != null && check_snum.get(ds000r.snum) == null)
         {
      	 ...
      	 total++;
         TT_sFactory   fac1 = new TT_sFactory(ds000r.snum,arg[0]);
         TT_oFactory   fac2 = new TT_oFactory(ds000r.snum,arg[0]);
         ...
         TT_Pattern   ptn1 = new TT_Pattern(markLine,basicGroup);
         try
         {
