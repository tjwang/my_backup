...
public class XTET_sFactory extends KDataLineFactory{
    ...
    public    XTET_sFactory()
    {
    }
    
    public    XTET_sFactory(String snum,String stardate) throws Exception
    {
        _snum = snum;
    ...
    public void loadKData(String snum,String stardate) throws Exception
    {
        ...
        Enumeration e = null;
        if(stardate == null){
            e = pkr.SelectBySQL("select snum,date,time,open,high,low,close,ra as volume,diff as money from  pamountinfo7 where   snum='"+snum+"' order by date,time "  ); 
        }else {
            e = pkr.SelectBySQL("select snum,date,time,open,high,low,close,ra as volume,diff as money from  pamountinfo7 where   snum='"+snum+"' and date > '"+stardate+"' order by date,time "  );    
        }
