 ...
 static void loadTargets(String filename)  throws Exception
{
 ...
 static public void main(String[] arg)throws Exception{
      ...
      JFrame jf2 = new JFrame("XTET_tUI");
      jp2= new JScrollPane();

      JFrame jf_xd = new JFrame("XTET_tUI_Xd");
...
/******************* Source Data Select******************/
      XTET_sFactory  fac1 = new XTET_sFactory(snum,dss);
      XTET_oFactory  fac2 = new XTET_oFactory(snum,dss);
...
//  Region  1 <Factory1>   
     ...
     } else
     {
      ...
      mp.addPainting(new MAPainting(fac1_lines[1],new Color(200,0,0)),"MA5",0);
...
*/
{
      ...
      Line vl = mkl.getVol();
      mp_xd.addPainting(new PoPainting(cl.transTo(vl),new Color(200,0,0)),"MA5",0);
}
