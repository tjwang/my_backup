...
public class CulMoney {
 ...
 static public void main(String[] arg)throws Exception{
    ...
    Enumeration e = pcppr.SelectBySQL("select * from pcpprice  where"+
                                     " date > '"+arg[0]+"'  and cp_month='"+arg[1]+"' order by type,date,ra;"); 
    ...
    String cp_date = null; 
     ...
     dbstmt.executeUpdate("delete from pcp1") ;

     dbstmt.executeUpdate("load data infile \""+ GlobleSetting.getTSCodePath()+"\\\\ºâ¿ï¾ÜÅv\\\\data.txt\" into table pcp1 FIELDS  TERMINATED by '|' ;");
}
