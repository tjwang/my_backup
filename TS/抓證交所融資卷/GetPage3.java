...
//    } 
  ...
  static boolean getData(String Dstr) throws Exception{
    ...
    int count = 0;
    URL u = new URL("http://www.twse.com.tw/ch/trading/exchange/MI_MARGN/MI_MARGN_2.php?select2=MS&input_date="+Dstr.substring(0,4)+"/"+Dstr.substring(4,6)+"/"+Dstr.substring(6,8)+"&type=csv");
