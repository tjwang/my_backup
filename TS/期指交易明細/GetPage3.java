...
DBConnection.debug = false;
  String filename ="Daily_"+ dateStr.substring(0,4)+"_"+dateStr.substring(4,6)+"_"+dateStr.substring(6,8)+".zip";
  String filelink = "http://www.taifex.com.tw/chinese/7/Daily_FUT.asp";
  System.out.println(filelink);
  u1 = new URL(filelink);
  URLConnection conn = u1.openConnection(); 
  setCookie(conn);
  FileOutputStream os = new FileOutputStream("Daily_FUT_"+dateStr.substring(0,6)+".csv");
