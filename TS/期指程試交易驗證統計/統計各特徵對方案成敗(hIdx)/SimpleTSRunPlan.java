...
public class  SimpleTSRunPlan implements TSRunPlan {
   ...
   public static final int tMode_NUM = 3;

   public static final double UPBOUND = 9400;
   public static final double LOWBOUND = 8180;

   public static final int PATTEN_MA = 0;
   public static final int PATTEN_K = 1;
   public static final int PATTEN_KD = 2;
   public static final int PATTEN_V = 3;
   public static final int tpMode_NUM = 4;
   ...
   static public int tpMode = PATTEN_MA;
           ...
           double v_v = vl.valueAt(vl.length()-1).getValue();
        	 ...
        	 switch(tpMode)
        	 {
        	    ...
        	    case PATTEN_KD:
        	       ...
        	       break;
        	    case PATTEN_V:
        	       _sta_fs = _sta_fs = culFs(v_min,v_mav3,v_mav8,0,v_max,v_v);
        	       break;
           }        	 
