...
public class S4_TransactionManager {
   ...
   public void setFeature(String ds,int ti,String fs)
   {
      _sta_dateStr = ds;
      _sta_timei = ti;
      _sta_featStr = fs;
    	      ...
    	      //         System.out.println("Transaction.COVERING");
   	         ...
   	         //       System.setOut(tps);
   	                if(is_ever_covering)
   	                {
  	                   ...
  	                   //    stock.tool.TimeIdxHash.gPut(_sta_dateStr, _sta_timei, _sta_featStr, false);
   	                    }else
   	                    {
   	                   //    stock.tool.TimeIdxHash.gPut(_sta_dateStr, _sta_timei, _sta_featStr, true);
