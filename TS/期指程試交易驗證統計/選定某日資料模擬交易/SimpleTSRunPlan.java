...
public class  SimpleTSRunPlan implements TSRunPlan {
   ...
   public static final String[] Reference_Dates={"20141125", "20141105", "20141110"};
              ...
              if( up_p_ma > 0.4 && up_p_ma > down_p_ma  && (up_p_v) > 0)
   	          {
        	       ...
        	       int buy_v = (int)(v-0);
        	       my_trans = new F_TSM_Transaction(fsrc, center, center-buy_v, "MXFL4", _isEasy);
        	       log_ps.println("create transaction "+_sta_fs_ma+" t:"+kl_ex.valueAt(endIdx).getTimeValue()+" case1:"+((int)buy_v));
        	       log_ps.println("up_p_ma: "+up_p_ma+" up_p_k:"+up_p_k);
   	          } else if(down_p_ma > 0.5 && down_p_ma > up_p_ma && (down_p_v) > 0)
        	    {
        	       ...
        	       log_ps.println("down_p_ma: "+down_p_ma+" down_p_k:"+down_p_k);
        	       my_trans = new F_TSM_Transaction(fsrc, center, sell_v-center, "MXFL4", _isEasy);
   	          } else
   	          {
